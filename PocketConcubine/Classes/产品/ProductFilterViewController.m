...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == _classesTab) {
        ...
        NSLog(@"row == %@",_datas[indexPath.row]);
...
- (void)eventWithSure
{
    ...
    {
        [self pushViewController:[[ProductSearchViewController alloc] initWithKeywords:@"" classesid:_classesid subclassesid:_subclassesid]];
    }
    else
    {
