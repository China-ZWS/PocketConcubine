...
- (id)initWithSelect:(void(^)(id data))select;
{
    ...
    if ((self = [super initWithFrame:CGRectMake(0, 0, DeviceW, DeviceW / kTop3Scale)])) {
        self.delegate = self;
...
- (void)setData:(NSArray *)data
{
    ...
    for (int i = 0;i < _data.count; i ++)
    {
        ...
        UIImageView *view = [[UIImageView alloc] initWithFrame:CGRectMake(i * DeviceW, CGRectGetMinY(self.frame), DeviceW, CGRectGetHeight(self.frame))];
        view.tag = i;
    ...
    _pageControl=[[QBluePageControl alloc]initWithFrame:CGRectMake(0,CGRectGetHeight(self.frame) - 20, DeviceW , 20)];
