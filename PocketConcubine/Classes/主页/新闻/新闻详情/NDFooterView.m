...
@interface NDFooterCell : UICollectionViewCell
@property (nonatomic, strong) UIImageView *imageView;
@property (nonatomic, strong) UILabel *title;

@end

@implementation NDFooterCell
...
- (void)layoutViews
{
    ...
    [_collectionView registerClass:[NDFooterCell class] forCellWithReuseIdentifier:@"cell"];
...
{
    NDFooterCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
