...
@interface ADFooterCell : UICollectionViewCell
@property (nonatomic, strong) UIImageView *imageView;
@property (nonatomic, strong) UILabel *title;

@end

@implementation ADFooterCell
...
- (void)layoutViews
{
    ...
    [_collectionView registerClass:[ADFooterCell class] forCellWithReuseIdentifier:@"cell"];
                  ...
                  cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ADFooterCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
    cell.backgroundColor = [UIColor clearColor];
    NSDictionary * datas = _datas[@"recommends"][indexPath.row];
    
    [cell.imageView sd_setImageWithURL:[NSURL URLWithString:datas[@"advertImg"] ] placeholderImage:[UIImage imageNamed:@"bk_3_2.png"]];
