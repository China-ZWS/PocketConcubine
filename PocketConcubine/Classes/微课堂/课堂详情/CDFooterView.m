...
@interface CDFooterCell : UICollectionViewCell
@property (nonatomic, strong) UIImageView *imageView;
@property (nonatomic, strong) UILabel *title;
@end

@implementation CDFooterCell
...
- (void)layoutViews
{
    ...
    [_collectionView registerClass:[CDFooterCell class] forCellWithReuseIdentifier:@"cell"];
                  ...
                  cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CDFooterCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
