...
+ (NSMutableURLRequest *)requestWithMethod:(NSString *)method parameter:(NSDictionary *)parameter URLString:(NSString *)URLString;
{
    ...
    NSString *account = [Infomation readInfo]?[Infomation readInfo][@"id"]:@"";
    NSString *secret_key = [Infomation readInfo][@"secret_key"];
    NSString *code = @"1";
    
    NSString *all = [NSString stringWithFormat:@"param=%@&code=%@&secret_key=%@&account=%@",[parameter JSONString],code,secret_key,account];
