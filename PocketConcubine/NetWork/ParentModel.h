...
+ (NSURLConnection *)POST:(NSString *)string parameter:(NSMutableDictionary *)parameter class:( id)class  success:(void (^)(id data))success failure:(void (^)(NSString *msg, NSString *status ))failure;
